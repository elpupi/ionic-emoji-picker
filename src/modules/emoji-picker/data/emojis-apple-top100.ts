...
import { ByCategory, Collections } from '@model/emoji/collections';

export class EmojisAppleTop100 extends Collections {
    ...
    constructor() {
        ...
        for (let i = 0; i < EmojisAppleTop100.all.length; ++i) {
            emoji = EmojisAppleTop100.all[i];
